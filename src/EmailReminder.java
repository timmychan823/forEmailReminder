...
public class EmailReminder {
    public static void main(String[] args) throws Exception{
        try{
            ...
            writer.write("Subject: [DBA][SYSADM] Password Expiry Reminder "+ warning_heading+"\nTo: "+toAddress+"\nContent-Type: text/html; charset=\"UTF-8\"\n\n");
            writer.write("The following accounts' passwords will expire soon:\n");
            writer.write(String.format("<table border=\"1\"><tr><th>%s</th><th>%s</th><th>%s</th></tr>","USER_ID","Number of days before expiry","Expiry date")+"\n"); //change to correct column names later
            while (rs.next()) {
